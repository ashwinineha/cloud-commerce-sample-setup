...
public class DataSourceFactory implements FactoryBean<DataSource>
{
	...
	public DataSource getObject() throws Exception
	{
		...
		poolConfig.setDriverClassName(config.getString("rediscart.storage.jdbc.driver"));
		poolConfig.setJdbcUrl(config.getString("rediscart.storage.jdbc.url"));
		poolConfig.setUsername(config.getString("rediscart.storage.jdbc.user"));
		poolConfig.setPassword(config.getString("rediscart.storage.jdbc.password"));
		poolConfig.setPoolName(getCurrentTenantId());
		poolConfig.setMaximumPoolSize(config.getInt("rediscart.storage.jdbc.pool.size"));
	...
	{
		final String propsPrefix = "rediscart.storage.jdbc.props";
		config.getKeys("rediscart.storage.jdbc.props").forEachRemaining(key -> {
